...
class Employee {
    ...
    constructor(firstName, lastName, employeeRoleId, managerName) {        
        this.firstName = firstName;
        this.lastName = lastName;
        this.employeeRoleId = employeeRoleId;
    ...
    //         for (let i = 0; i < results.length; i++){           
    //             if(results[i].manager === this.managerName) {
    //                 this.employeeMgrId  = results[i].id;                
    //                 console.log(this.employeeMgrId);  
    //                 // addManager(employeeMgrId);
    //                 return this.employeeMgrId;              
    //             }
    //         }
    //     });
